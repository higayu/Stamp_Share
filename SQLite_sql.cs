    ...
    public class SqliteList {
       ...
       // public static string DBFolder = @"DBList";
        ...
        public bool Dictionary_KEY_Change(string newName,string oldName,string newFullPath) {
            ...
            this.FolderPath = Path.GetDirectoryName(newFullPath);
            try {
                SQLite_sql newDB = new SQLite_sql(newKey, FolderPath);
        ...
        public bool newDataBase(string newDBFilename,string newFullPath) {
